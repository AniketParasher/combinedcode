...
def create_attendance_pdf(pdf, column_widths, column_names, image_path, info_values, df):
    ...
    pdf.image(image_path, x=pdf.get_x() + 150, y=pdf.get_y() - 8, w=15, h=5)  # Adjust position and size as needed
...
def main():        
    ...
    # if st.session_state['mapped_data'] is not None:
        # Centered title
        st.markdown("<h1 style='text-align: center;'>Attendance Sheet Generator</h1>", unsafe_allow_html=True)
