...
def create_attendance_pdf(pdf, column_widths, column_names, image_path, info_values, df, format_type):
    pdf.add_page()
        ...
        if st.button("Click to Generate PDFs and Zip"):
            with tempfile.TemporaryDirectory() as tmp_dir:
                ...
                for index, record in enumerate(result):
                    ...
                    create_attendance_pdf(pdf, column_widths, column_names, image_path, info_values, df, format_type)
